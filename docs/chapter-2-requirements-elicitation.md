...
![](../assets/img/tablero1.jpg){ width=70% }
...
![](../assets/img/tablero2.jpg){ width=70% }

## 2.5 Ubiquitous Language

- **Producto Perecible:** Ítem con fecha de vencimiento limitada.  
- **Lote:** Conjunto de productos con la misma fecha de producción y vencimiento.  
- **Inventario:** Registro de todos los productos disponibles en el sistema.  
- **Almacén:** Lugar físico donde se conservan los productos.  
- **Ubicación:** Posición específica dentro del almacén.  
